...
/**
 * PDBGetHouseFansResp message
 */
class PDBGetHouseFansResp extends \ProtobufMessage
{
    ...
    public function reset()
    {
        ...
        $this->values[self::ARRLIKETIME] = array();
    }
    ...
    /**
     * Appends value to 'arrLikeTime' list
     *
     * @param integer $value Value to append
     *
     * @return null
     */
    public function appendArrLikeTime($value)
    {
        return $this->append(self::ARRLIKETIME, $value);
    }

    /**
     * Clears 'arrLikeTime' list
     *
     * @return null
     */
    public function clearArrLikeTime()
    {
        return $this->clear(self::ARRLIKETIME);
    }

    /**
     * Returns 'arrLikeTime' list
     *
     * @return integer[]
     */
    public function getArrLikeTime()
    {
        return $this->get(self::ARRLIKETIME);
    }

    /**
     * Returns true if 'arrLikeTime' property is set, false otherwise
     *
     * @return boolean
     */
    public function hasArrLikeTime()
    {
        return count($this->get(self::ARRLIKETIME)) !== 0;
    }

    /**
     * Returns 'arrLikeTime' iterator
     *
     * @return \ArrayIterator
     */
    public function getArrLikeTimeIterator()
    {
        return new \ArrayIterator($this->get(self::ARRLIKETIME));
    }

    /**
     * Returns element from 'arrLikeTime' list at given offset
     *
     * @param int $offset Position in list
     *
     * @return integer
     */
    public function getArrLikeTimeAt($offset)
    {
        return $this->get(self::ARRLIKETIME, $offset);
    }

    /**
     * Returns count of 'arrLikeTime' list
     *
     * @return int
     */
    public function getArrLikeTimeCount()
    {
        return $this->count(self::ARRLIKETIME);
    }
}
}