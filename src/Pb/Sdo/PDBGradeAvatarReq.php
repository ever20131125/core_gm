...
/**
 * PDBGradeAvatarReq message
 */
class PDBGradeAvatarReq extends \ProtobufMessage
{
    ...
    /**
     * Sets value of 'bCheck' property
     *
     * @param boolean $value Property value
     *
     * @return null
     */
    public function setBCheck($value)
    {
        return $this->set(self::BCHECK, $value);
    }

    /**
     * Returns value of 'bCheck' property
     *
     * @return boolean
     */
    public function getBCheck()
    {
        $value = $this->get(self::BCHECK);
        return $value === null ? (boolean)$value : $value;
    }

    /**
     * Returns true if 'bCheck' property is set, false otherwise
     *
     * @return boolean
     */
    public function hasBCheck()
    {
        return $this->get(self::BCHECK) !== null;
    }
}
}