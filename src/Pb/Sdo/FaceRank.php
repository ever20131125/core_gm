 ...
 * FaceRank message
 */
class FaceRank extends \ProtobufMessage
{
    ...
    /**
     * Sets value of 'nLike' property
     *
     * @param integer $value Property value
     *
     * @return null
     */
    public function setNLike($value)
    {
        return $this->set(self::NLIKE, $value);
    }

    /**
     * Returns value of 'nLike' property
     *
     * @return integer
     */
    public function getNLike()
    {
        $value = $this->get(self::NLIKE);
        return $value === null ? (integer)$value : $value;
    }

    /**
     * Returns true if 'nLike' property is set, false otherwise
     *
     * @return boolean
     */
    public function hasNLike()
    {
        return $this->get(self::NLIKE) !== null;
    }
}
}