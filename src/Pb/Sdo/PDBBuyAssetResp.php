...
/**
 * PDBBuyAssetResp message
 */
class PDBBuyAssetResp extends \ProtobufMessage
{
    ...
    /**
     * Sets value of 'nCriMul' property
     *
     * @param integer $value Property value
     *
     * @return null
     */
    public function setNCriMul($value)
    {
        return $this->set(self::NCRIMUL, $value);
    }

    /**
     * Returns value of 'nCriMul' property
     *
     * @return integer
     */
    public function getNCriMul()
    {
        $value = $this->get(self::NCRIMUL);
        return $value === null ? (integer)$value : $value;
    }

    /**
     * Returns true if 'nCriMul' property is set, false otherwise
     *
     * @return boolean
     */
    public function hasNCriMul()
    {
        return $this->get(self::NCRIMUL) !== null;
    }
}
}