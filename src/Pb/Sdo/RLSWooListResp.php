...
/**
 * RLSWooListResp message
 */
class RLSWooListResp extends \ProtobufMessage
{
    ...
    protected static $fields = array(
        ...
        self::DETAILS => array(
            'name' => 'details',
            'repeated' => true,
            'type' => '\Xnhd\Core\Pb\Sdo\WooDetail'
        ),
    );
     ...
     *
     * @param \Xnhd\Core\Pb\Sdo\WooDetail $value Value to append
     *
     * @return null
     */
    public function appendDetails(\Xnhd\Core\Pb\Sdo\WooDetail $value)
    {
     ...
     *
     * @return \Xnhd\Core\Pb\Sdo\WooDetail[]
     */
