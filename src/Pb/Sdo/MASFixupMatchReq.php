...
/**
 * MASFixupMatchReq message
 */
class MASFixupMatchReq extends \ProtobufMessage
{
    ...
    public function reset()
    {
        ...
        $this->values[self::MATCHROOMID] = null;
    ...
    /**
     * Sets value of 'matchRoomID' property
     *
     * @param integer $value Property value
     *
     * @return null
     */
    public function setMatchRoomID($value)
    {
        return $this->set(self::MATCHROOMID, $value);
    }

    /**
     * Returns value of 'matchRoomID' property
     *
     * @return integer
     */
    public function getMatchRoomID()
    {
        $value = $this->get(self::MATCHROOMID);
        return $value === null ? (integer)$value : $value;
    }

    /**
     * Returns true if 'matchRoomID' property is set, false otherwise
     *
     * @return boolean
     */
    public function hasMatchRoomID()
    {
        return $this->get(self::MATCHROOMID) !== null;
    }
