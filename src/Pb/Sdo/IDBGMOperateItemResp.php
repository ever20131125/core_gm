...
/**
 * IDBGMOperateItemResp message
 */
class IDBGMOperateItemResp extends \ProtobufMessage
{
     ...
     * @return null
     */
    public function appendArrFailed(\Xnhd\Core\Pb\Sdo\ManageItem $value)
    {
     ...
     * @return null
     */
    public function appendArrSuccess(\Xnhd\Core\Pb\Sdo\ManageItem $value)
    {
