...
/**
 * GASChangePosTypeReq message
 */
class GASChangePosTypeReq extends \ProtobufMessage
{
    ...
    public function reset()
    {
        ...
        $this->values[self::NCHANGETYPE] = self::$fields[self::NCHANGETYPE]['default'];
    }
    ...
    /**
     * Sets value of 'nChangeType' property
     *
     * @param integer $value Property value
     *
     * @return null
     */
    public function setNChangeType($value)
    {
        return $this->set(self::NCHANGETYPE, $value);
    }

    /**
     * Returns value of 'nChangeType' property
     *
     * @return integer
     */
    public function getNChangeType()
    {
        $value = $this->get(self::NCHANGETYPE);
        return $value === null ? (integer)$value : $value;
    }

    /**
     * Returns true if 'nChangeType' property is set, false otherwise
     *
     * @return boolean
     */
    public function hasNChangeType()
    {
        return $this->get(self::NCHANGETYPE) !== null;
    }
}
}