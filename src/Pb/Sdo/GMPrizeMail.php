 ...
 * GMPrizeMail message
 */
class GMPrizeMail extends \ProtobufMessage
{
    ...
    const NMINVIP = 9;
    const NMAXVIP = 10;
    const NMINCREATEROLETIME = 11;
    const NMAXCREATEROLETIME = 12;
    const NSOURCE = 13;
    const SZTITLE = 14;
    const SZCONTENT = 15;
    const ARRITEMLIST = 16;
    const NEFFECTTIME = 17;
    const ARRSDKSOURCE = 18;
    const SZEXTENDSOURCE = 19;
    ...
    public function reset()
    {
        ...
        $this->values[self::NADDTIME] = null;
    ...
    /**
     * Sets value of 'nAddTime' property
     *
     * @param integer $value Property value
     *
     * @return null
     */
    public function setNAddTime($value)
    {
        return $this->set(self::NADDTIME, $value);
    }

    /**
     * Returns value of 'nAddTime' property
     *
     * @return integer
     */
    public function getNAddTime()
    {
        $value = $this->get(self::NADDTIME);
        return $value === null ? (integer)$value : $value;
    }

    /**
     * Returns true if 'nAddTime' property is set, false otherwise
     *
     * @return boolean
     */
    public function hasNAddTime()
    {
        return $this->get(self::NADDTIME) !== null;
    }
