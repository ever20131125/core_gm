...
/**
 * GASGetMyWeddingResp message
 */
class GASGetMyWeddingResp extends \ProtobufMessage
{
    ...
    protected static $fields = array(
        ...
        self::ARRWEDDINGINFO => array(
            'name' => 'arrWeddingInfo',
            'repeated' => true,
            'type' => '\Xnhd\Core\Pb\Sdo\WeddingInfo'
        ),
    );
     ...
     *
     * @param \Xnhd\Core\Pb\Sdo\WeddingInfo $value Value to append
     *
     * @return null
     */
    public function appendArrWeddingInfo(\Xnhd\Core\Pb\Sdo\WeddingInfo $value)
    {
     ...
     *
     * @return \Xnhd\Core\Pb\Sdo\WeddingInfo[]
     */
